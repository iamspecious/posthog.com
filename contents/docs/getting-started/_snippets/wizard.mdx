...
**No framework?** If your site is plain HTML — a static site, a GitHub Pages portfolio — you don't need the wizard at all!
Just use the **JS snippet** tab above instead. It's a single copy-paste into your `<head>`. 
